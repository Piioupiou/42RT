...
- (void)processKeys: (NSTimer *)tim
{

  if ([keysPressed count] != 0 && (event_funct[2] != NULL ||  event_funct[3] != NULL)){
    ...
    while (keyHit = [enumerator nextObject]){
      switch ([keyHit unsignedIntValue]){
        ...
        event_funct[2] != NULL ? event_funct[2](126, event_param[2]) : event_funct[3](126, event_param[3]);
        break;
        case NSDownArrowFunctionKey:
         event_funct[2] != NULL ?  event_funct[2](125, event_param[2]): event_funct[3](125, event_param[3]);
        break;
        case NSRightArrowFunctionKey:
         event_funct[2] != NULL ?  event_funct[2](124, event_param[2]): event_funct[3](124, event_param[3]);
        break;
        case NSLeftArrowFunctionKey:
         event_funct[2] != NULL ? event_funct[2](123, event_param[2]): event_funct[3](123, event_param[3]);
        break;
      }
    }
  }
